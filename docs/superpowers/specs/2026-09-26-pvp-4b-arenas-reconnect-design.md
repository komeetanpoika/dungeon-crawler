...
- The browser's "Duplicate tab" copies `sessionStorage`, so a duplicated tab resumes the seat and the original tab gets 4001 (`Connection lost`) — accepted, owner-side only.
