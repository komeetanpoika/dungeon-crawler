...
describe('shipped open maps', () => {
  ...
  it('rim every water cell that touches land', () => {
    for (const m of Object.values(OPEN_MAPS)) {
      ...
      const wet = (x, y) => { const n = skin(x, y); return n === undefined || n.startsWith('ow_water') || n.startsWith('ow_pond_') || n.startsWith('ow_shore_') || n.startsWith('ow_mud_') || n === 'ow_pier_log' }
